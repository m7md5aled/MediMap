...
public class Admin_Addpharma extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_addpharam);
            ...
            public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (com.google.firebase.database.DataSnapshot snapshot1 : dataSnapshot.getChildren()) {
                        ...
                        Toast.makeText(Admin_Addpharma.this, "Name is Already Exist ", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void add_unit ()
    {
...

        {
            ...
            reference = FirebaseDatabase.getInstance().getReference("Pharmacist");
